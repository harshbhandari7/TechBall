...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Offside90</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#techstuff">Tech-stuff</a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <h1 class="brand-heading">Tranfer Rumors:</h1>
              <p class="intro-text">Manchester United Tranfer News: Robert Lewandowski, Christian Eriksen rumors.
                </p><br/>
    ...
    <!-- Sports Section -->
    <section id="sports" class="download-section content-section text-center">
      <div class="container">
        <div class="col-lg-8 mx-auto">
    ...
    <!-- Tech Section -->
    <section id="techstuff" class="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
  ...
  <div class="container">
    ...
    <footer>
      <div class="container text-center">
        <p>Copyright &copy; Harsh Mandalgi | 2018</p>
      </div>
    </footer>
